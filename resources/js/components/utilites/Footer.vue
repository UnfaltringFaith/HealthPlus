    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div class="md:col-span-2">
          <h3 class="text-2xl font-bold text-blue-400 mb-4">HealthPlus</h3>
          <p class="text-gray-300 mb-4 max-w-md">
            Современная платформа для управления здоровьем. Отслеживайте показатели, планируйте визиты к врачам и ведите здоровый образ жизни.
          </p>
        ...
        <div>
          ...
          <ul class="space-y-2">
            ...
            <li>
              <router-link to="/posts" class="text-gray-300 hover:text-white transition-colors">
                Посты
              </router-link>
            </li>
            <li>
      ...
      <div class="border-t border-gray-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
        <p class="text-gray-400 text-sm">
          © {{ new Date().getFullYear() }} HealthPlus. Все права защищены.
        </p>
